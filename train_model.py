...
checkpoint = ModelCheckpoint('hiragana_best_model.h5', monitor='val_loss', save_best_only=True, mode='min')
...
model.save('hiragana_model.h5')  # Save the final trained model
