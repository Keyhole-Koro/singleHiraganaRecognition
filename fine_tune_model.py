...
model = load_model('hiragana_model.h5')  # Load the pre-trained model
...
checkpoint = ModelCheckpoint('hiragana_best_finetuned_model.h5', monitor='val_loss', save_best_only=True, mode='min')
...
model.save('hiragana_model_finetuned.h5')  # Save the final fine-tuned model
